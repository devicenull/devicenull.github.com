...
<pre class="code">
	CFLAGS='-march=i686 -O2' CC=gcc44 CXX=gcc44-c++ ../configure --prefix=/home/glibc215 --with-binutils=/home/newbinutils/bin/ && make -j 4 && make install
</pre>
...
<pre class="code">
	#!/bin/bash
	/home/glibc215/lib/ld-linux.so.2 --library-path /home/glibc215/lib/:. ./hlds_i686 $*
</pre>
